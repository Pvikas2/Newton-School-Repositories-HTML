...
function showtask(){
    ...
    taskObj.forEach((item, index) => {
        ...
        html += `<tr>
                    ...
                    ${taskCompleteValue}
                    <td><button type="button" onclick="edittask(${index})" class="text-primary"><i class="bi bi-pencil-square blue"></i>Edit</button></td>
                    <td><button type="button" class="text-success complete" id=${index}><i class="bi bi-check-circle green"></i>Complete</button></td>
                    <td><button type="button" onclick="deleteitem(${index})" class="text-danger"><i class="bi-x-circle red"></i>Delete</button></td>
                </tr>`;
    });
